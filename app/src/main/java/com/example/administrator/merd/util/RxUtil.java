package com.example.administrator.merd.util;


import com.example.administrator.merd.model.http.exception.ApiException;
import com.example.administrator.merd.model.http.response.GankHttpResponse;
import com.example.administrator.merd.model.http.response.GoldHttpResponse;
import com.example.administrator.merd.model.http.response.MyHttpResponse;
import com.example.administrator.merd.model.http.response.WXHttpResponse;
